# QA known-answer packet (generation 3, v3) -- maker fill model -- manifest
...
| file | columns | rows |
|---|---|---|
| `ticker_qa_maker3_v3_tape.csv.gz` | ts,best_bid,best_ask,best_bid_size,best_ask_size | 340617 |
| `executions_qa_maker3_v3_tape.csv.gz` | id,ts,price,size,side | 36904 |
...
- Generated: 2026-09-05T08:17:08.256457+00:00 (seed 20260910).
