...
| Binance COIN-M metrics のレバレッジ関連列(`count_toptrader_long_short_ratio` / `sum_toptrader_long_short_ratio` / `count_long_short_ratio`) | `backtest_data/binance_cm_o3c_20260913/metrics/BTCUSD_PERP/` | サンプル 7 日(2023-06-25/26, 2024-01-02/03, 2024-10-12〜14)・2,016 行で 3 列とも全部空欄。他 5 列は空欄 0 | 取得済(列自体は空。全期間は未確認、原因未確認) | 2026-09-17 | `docs/AUDITOR/ACTION_LOG.md` 049(リード再計算) | O-3c 段 2 の 3 件目(§9) |
