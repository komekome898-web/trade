...
委任文 §12 のコマンドを、**生ログを 5 本とも渡して**打った最後の出力の全文。
...
K5 同じ道具に別の値            0 件
K6 未実施と実測の同居           1 件
    docs/DATA/SCAN_2026-09-21_tools.md:2811  OctoBot: wheel/setup.py が「未実施・未確認」と「実施済み」の両方にある (行 [2811] / [2802, 2819, 2824, 2825, 2826, 2840, 2864])
K7 表の項目の欠落             0 件
K8 表の印と根拠              0 件
K9 表に無い数値              0 件
K10 見出しの件数             0 件
...
K13 中身が実質空             0 件
K12 検査の出力の貼付           0 件
---- 検査対象の合計 1 件(K12 を除く。貼り付けはこの数で照合する)
---- 合計 1 件
```
