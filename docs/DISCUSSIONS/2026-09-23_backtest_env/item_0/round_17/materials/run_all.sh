#!/bin/sh
# Item 0, round 17, materials person: run every configured target of
...
# Round 17: the scene-set fingerprint differs from round 16's (38460620...
# -> 966d5d86...), so every configured target is run (L-435). Candidate 35
...
# Usage (from the repo root): sh docs/DISCUSSIONS/2026-09-23_backtest_env/item_0/round_17/materials/run_all.sh
set -u
REPO=$(pwd)
