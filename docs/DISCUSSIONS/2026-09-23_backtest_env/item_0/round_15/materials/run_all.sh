#!/bin/sh
# Item 0, round 15, materials person: run every configured target of
...
# Round 15: the scene-set fingerprint differs from round 14's (dff3bc73...
# -> cb42e201...), so every configured target is run (L-435). Candidate 35
...
# Usage (from the repo root): sh docs/DISCUSSIONS/2026-09-23_backtest_env/item_0/round_15/materials/run_all.sh
set -u
REPO=$(pwd)
M=docs/DISCUSSIONS/2026-09-23_backtest_env/item_0/round_15/materials
