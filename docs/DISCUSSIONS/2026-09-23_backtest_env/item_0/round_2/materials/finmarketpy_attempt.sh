#!/bin/bash
# Item 0, round 2, materials person: one more attempt to install the survey
...
# Usage (from the repo root): bash docs/DISCUSSIONS/2026-09-23_backtest_env/item_0/round_2/materials/finmarketpy_attempt.sh
set -u
M=docs/DISCUSSIONS/2026-09-23_backtest_env/item_0/round_2/materials
...
PIPOUT=$B/item0_r2_materials_finmarketpy_pip.out
MARK=$B/item0_r2_materials_finmarketpy.mark
: > "$LOG"
touch "$MARK"
