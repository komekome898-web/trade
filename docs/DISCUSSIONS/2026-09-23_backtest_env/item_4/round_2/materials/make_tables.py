#!/usr/bin/env python3
"""Item 4, round 2, table-maker: build the six blind comparison tables from
...
HERE = Path(__file__).resolve().parent            # .../round_2/materials
ROUND = HERE.parent                               # .../round_2
