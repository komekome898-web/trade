#!/bin/bash
# Item 4 round 1 table-maker: run every target of i4_targets.py through the battery runner twice
...
set -u
M=docs/DISCUSSIONS/2026-09-23_backtest_env/item_4/round_1/materials
