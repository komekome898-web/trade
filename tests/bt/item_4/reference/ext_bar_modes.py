# Round-1 multi-mode bar reference, moved here unchanged on 2026-09-26. It is kept
# only for the recorded external-tool comparison (ext_backtesting_compare.py,
# test_i4ref_ext_recorded.py) and its own tests (test_i4ref_extmodes_*.py).
# It is NOT the rule reference; that is src/bot/bt/reference/bar_sim.py (SPEC.md).
